const factoryAbi = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "indexed": false, "internalType": "address", "name": "deployedTender", "type": "address" },
      { "indexed": false, "internalType": "string",  "name": "category",       "type": "string"  },
      { "indexed": false, "internalType": "string",  "name": "image",          "type": "string"  },
      { "indexed": false, "internalType": "uint256", "name": "createTime",     "type": "uint256" }
    ],
    "name": "CreatedTender",
    "type": "event"
  },
  {
    "anonymous": false,
    "inputs": [
      { "indexed": false, "internalType": "uint256", "name": "regNumber",      "type": "uint256" },
      { "indexed": true,  "internalType": "address", "name": "client",         "type": "address" },
      { "indexed": false, "internalType": "string",  "name": "pdf",            "type": "string"  },
      { "indexed": false, "internalType": "uint256", "name": "registeredTime", "type": "uint256" }
    ],
  ...
  },
  {
    "anonymous": false,
    "inputs": [
      { "indexed": true,  "internalType": "uint256", "name": "protocolNum", "type": "uint256" },
      { "indexed": true,  "internalType": "address", "name": "client",      "type": "address" },
      { "indexed": true,  "internalType": "address", "name": "authorizer",  "type": "address" },
      { "indexed": false, "internalType": "uint256", "name": "timestamp",   "type": "uint256" }
    ],
    "name": "ProtocolValidated",
    "type": "event"
  },
  {
    "anonymous": false,
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "uint256", "name": "protocolNum", "type": "uint256" }
    ],
  ...
  },
  {
    ...
    "name": "ProtocolRejected",
    "type": "event"
  },
  {
    "inputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }],
    "name": "rejectedProtocols",
    ...
    "outputs": [
      {
        "components": [
          ...
          { "internalType": "uint256", "name": "minimumContribution", "type": "uint256" },
...
const campaignAbi = [
  ...
  },
  {
    "anonymous": false,
    "inputs": [
      { "indexed": true,  "internalType": "uint256", "name": "requestNo",   "type": "uint256" },
  ...
  },
  {
    "inputs": [
      ...
      { "internalType": "string",  "name": "_url",         "type": "string"  },
      { "internalType": "uint256", "name": "_deadline",    "type": "uint256" },
      { "internalType": "address", "name": "_authorizer",  "type": "address" },
...
const factoryAddress = "0xC5479C7a3cd219C150C1629aAB2C043E04B65cF3";

// ES module export — works with all your import statements
export { factoryAbi, factoryAddress, campaignAbi };